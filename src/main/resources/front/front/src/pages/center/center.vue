<template>
<div class="center-preview" :style='{"width":"85%","margin":"20px auto","position":"relative","background":"none"}'>
        ...
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="头像">
            <el-upload
              ...
              <img :style='{"border":"1px solid #ddd","cursor":"pointer","color":"#333","borderRadius":"6px","textAlign":"center","background":"linear-gradient(240deg, rgba(246,246,246,1) 0%, rgba(246,246,246,1) 50%, rgba(238,238,238,1) 50%, rgba(238,238,238,1) 100%)","width":"100px","fontSize":"32px","lineHeight":"100px","height":"100px"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
          ...
          <el-form-item :style='{"padding":"0","textAlign":"center","margin":"0"}'>
            <el-button :style='{"border":"1px solid #9179f2","cursor":"pointer","padding":"0","boxShadow":"inset 0px 0px 56px 0px #7e5ffb","margin":"0 20px 0 0","color":"#111","outline":"none","borderRadius":"0","background":"#fff","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit('sessionForm')">更新信息</el-button>
            <el-button :style='{"border":"1px solid #dfd130","cursor":"pointer","padding":"0","boxShadow":"inset 0px 0px 36px 0px #f2e013","margin":"0","color":"#111","outline":"none","borderRadius":"0","background":"#fff","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="danger" @click="logout">退出登录</el-button>
          </el-form-item>
        </el-form>
