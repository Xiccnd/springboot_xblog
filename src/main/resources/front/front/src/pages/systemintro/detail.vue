		...
		<div class="attr" :style='{"padding":"0px","margin":"0 auto","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"85%","position":"relative"}'>
			...
			<div class="info" :style='{"border":"1px solid #eee","padding":"10px","margin":"0 0 0 5%","background":"rgba(255,255,255,.9)","display":"inline-block","width":"45%","minWidth":"540px","order":"2"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>标题</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.title}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>副标题</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.subtitle}}</div>
				</div>
