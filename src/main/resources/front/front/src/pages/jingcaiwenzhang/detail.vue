...
<div>
	...
	<div class="detail-preview" :style='{"width":"100%","margin":"0px auto","position":"relative","background":"none"}'>
		<div class="attr" :style='{"padding":"0px","margin":"0 auto","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"85%","position":"relative"}'>
			...
			<div class="zancai" :style='{"padding":"0","margin":"20px 0 0","background":"none","display":"flex","width":"100%","justifyContent":"center","order":"3"}'>
				<div :style='{"border":"1px solid #ddd","padding":"10px 0","margin":"0 20px 0 0","alignItems":"center","borderRadius":"20px","background":"#fff","display":"flex","width":"130px","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="zan" @click="thumbsupOrCrazily(21)">
				...
				<div :style='{"border":"1px solid #ddd","padding":"10px 0","margin":"0 20px 0 0","alignItems":"center","borderRadius":"20px","background":"#fff","display":"flex","width":"130px","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
				...
				<div :style='{"border":"1px solid #ddd","padding":"10px 0","margin":"0 20px 0 0","alignItems":"center","borderRadius":"20px","background":"#fff","display":"flex","width":"130px","justifyContent":"center"}' v-if="isThumbsupnum" class="zan" @click="cancelThumbsupOrCrazily(21)">
					<i :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-dianzan"></i>
					<span :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}'>取消赞({{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"border":"1px solid #ddd","padding":"10px 0","margin":"0 20px 0 0","alignItems":"center","borderRadius":"20px","background":"#fff","display":"flex","width":"130px","justifyContent":"center"}' v-if="isCrazilynum" class="cai" @click="cancelThumbsupOrCrazily(22)">
					<i :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-iconfontzan"></i>
			...
			<div class="info" :style='{"border":"1px solid #eee","padding":"10px","margin":"0 0 0 5%","background":"rgba(255,255,255,.9)","display":"inline-block","width":"45%","minWidth":"540px","order":"2"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>文章分类</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.wenzhangfenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>简述</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.jianshu}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>点击次数</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.clicknum}}</div>
				</div>
			...
			<el-tab-pane label="评论" name="second">
				<el-form class="add comment" :style='{"boxShadow":"0 1px 6px 0 rgba(0, 0, 0, .1)","padding":"15px","margin":"0 0 20px"}' :model="form" :rules="rules" ref="form">
					...
					<el-form-item class="btn" :style='{"width":"100%","padding":"0 0 0 80px","margin":"10px 0 0","height":"auto"}'>
						<el-button :style='{"border":"1px solid #9179f2","cursor":"pointer","padding":"0","boxShadow":"inset 0px 0px 56px 0px #7e5ffb","margin":"0 20px 0 0","color":"#111","outline":"none","borderRadius":"4px","background":"#fff","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="submitForm('form')">立即提交</el-button>
						<el-button :style='{"border":"1px solid #dfd130","cursor":"pointer","padding":"0","boxShadow":"inset 0px 0px 36px 0px #f2e013","margin":"0 20px 0 0","color":"#111","outline":"none","borderRadius":"4px","background":"#fff","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="resetForm('form')">重置</el-button>
					</el-form-item>
				</el-form>
				
				<div v-if="infoList.length" :style='{"padding":"15px"}' class="comment">
					<div :style='{"padding":"8px 0","margin":"0 0 20px","borderColor":"#999","alignItems":"center","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' v-for="item in infoList" :key="item.id">
						...
						<div :style='{"border":"1px solid #ddd","padding":"8px","margin":"10px 0px 0px","color":"#333","borderRadius":"4px","background":"linear-gradient(240deg, rgba(246,246,246,1) 0%, rgba(246,246,246,1) 50%, rgba(238,238,238,1) 50%, rgba(238,238,238,1) 100%)","lineHeight":"30px","fontSize":"14px","textIndent":"2em"}' class="content-block-ask">
							{{item.content}}
						</div>
						<div :style='{"border":"1px solid #ddd","padding":"8px","margin":"10px 0px 0px","color":"#333","borderRadius":"4px","background":"linear-gradient(240deg, rgba(246,246,246,1) 0%, rgba(246,246,246,1) 50%, rgba(238,238,238,1) 50%, rgba(238,238,238,1) 100%)","lineHeight":"30px","fontSize":"14px","textIndent":"2em"}' class="content-block-reply" v-if="item.reply">
							回复：{{item.reply}}
						</div>
					</div>
				</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.storeupParams.inteltype = this.detail.wenzhangfenlei;
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'jingcaiwenzhang', userid: localStorage.getItem('userid')}}).then(res => {
      ...
      thumbsupOrCrazily(type) {
        ...
        this.$http.post('jingcaiwenzhang/update', this.detail).then(res => {});
      },
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'jingcaiwenzhang', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'jingcaiwenzhang', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
      ...
      getDiscussList(page) {
        this.$http.get('discussjingcaiwenzhang/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussjingcaiwenzhang/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
