		...
		<div class="attr" :style='{"padding":"0px","margin":"0 auto","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"85%","position":"relative"}'>
			...
			<div class="info" :style='{"border":"1px solid #eee","padding":"10px","margin":"0 0 0 5%","background":"rgba(255,255,255,.9)","display":"inline-block","width":"45%","minWidth":"540px","order":"2"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>关联表id</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.refid}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>用户名</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.nickname}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>评论内容</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.content}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>回复内容</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.reply}}</div>
				</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getDiscussList(page) {
        this.$http.get('discussdiscussjingcaiwenzhang/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussdiscussjingcaiwenzhang/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
